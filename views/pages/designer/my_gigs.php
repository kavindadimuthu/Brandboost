    ...
    <style>
        ...
        * {
        ...
        .modal-content {
            ...
            /* Adjust vertical position for perfect centering */
            top: 50%;
            /* Center vertically */
            position: absolute;
            ...
            /* Adjust to center perfectly */
        }

        .modal-content p {
            margin: 0 0 20px;
            /* Margin for text in modal */
            font-size: 1.1em;
                                    ...
                                    if (gigs.length > 0) {
                                        gigs.forEach(gig => {
                                            ...
                                            row.innerHTML = `
                                                ...
                                                <td>
                                                    <button onclick="window.location.href='/designer/edit-gig/?gigId=${gig.gig_id}'" class="action-btn"><i class="fas fa-edit"></i></button>
