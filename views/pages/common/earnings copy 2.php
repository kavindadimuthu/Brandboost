    ...
    <div class="hero">
        <div class="hero-container">
            <div class="hero-content">
                <h1><i class="fas fa-wallet"></i> Earnings Dashboard</h1>
            ...
            <div class="earnings-card" id="period-earnings-card">
                ...
                <div class="card-body">
                    ...
                    <div class="date-range-wrapper">
                        ...
                        <div class="date-input-group">
                    <button id="filter-earnings-btn" class="btn btn-secondary btn-fullwidth">
                        <i class="fas fa-filter"></i> View Earnings
                    </button>
                        </div>
                    </div>
