...
<body>
  ...
  <div class="container">
    ...
    <div class="step active" id="step1">
      ...
      <button id="backStep1" onclick="window.location.href='/designerviewcontroller/designerPackages'">Back</button>
    </div>
    ...
    <div class="step" id="step2">
      ...
      <div style="padding:30px 0;">
        ...
        <div>
          <input type="checkbox" name="delivery_format" value="jpg" id="jpg">
          <label for="jpg">JPG</label>
        </div>
        <div>
          <input type="checkbox" name="delivery_format" value="png" id="png">
          <label for="png">PNG</label>
        </div>
        <div>
          <input type="checkbox" name="delivery_format" value="mp4" id="mp4">
          <label for="mp4">MP4</label>
        </div>
        <div>
          <input type="checkbox" name="delivery_format" value="psd" id="psd">
