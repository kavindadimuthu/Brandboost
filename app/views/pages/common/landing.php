    ...
    <!-- <footer class="footer">
        <div class="wrapper">
            ...
            <div class="footer-lower-container">
                ...
                <div class="copyright">© 2022 Brand, Inc. Privacy Terms Sitemap</div>
                <div class="social-media-links">
                    <img src="./assets/icons/social-media/icons8-twitterx.svg" alt="">
                    <img src="./assets/icons/social-media/icons8-facebook.svg" alt="">
                    <img src="./assets/icons/social-media/icons8-instagram.svg" alt="">
                    <img src="./assets/icons/social-media/icons8-youtube.svg" alt="">
                </div>
            </div>
        </div>
    </footer> -->
